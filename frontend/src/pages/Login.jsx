            ...
            <form onSubmit={handleLogin}>
                ...
                <div style={{ marginBottom: '2.5rem' }}>
                    ...
                    <div style={{ position: 'relative' }}>
                        <input type={showPassword ? "text" : "password"} value={password} onChange={(e) => setPassword(e.target.value)} required placeholder="Enter active password" disabled={isProcessing} style={{ paddingRight: '2.5rem' }} />
